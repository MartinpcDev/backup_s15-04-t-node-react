...
const isAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (typeof decodedToken === 'object' && decodedToken.id) {
            ...
            if (user.rol !== constants_1.ROLE.ADMIN) {
                throw new HttpException_1.HttpException(constants_1.CODE.UNAUTHORIZED_ACCESS, 'Necesitas ser Administrador para completar la operación');
            }
            else {
                req.user = user;
                next();
